...
function ServiceCard({ index, title, description, icon }) {
  return (
    <motion.article
      ...
      className="mx-auto flex w-full max-w-[190px] flex-col items-center text-center sm:max-w-[330px]"
    >
      <div
        className="service-orbit service-orbit-auto shine-sweep shine-sweep-auto relative flex aspect-square w-full items-center justify-center rounded-full border border-primary/25 bg-bgSecondaryLight/40 p-4 shadow-[0_18px_70px_rgba(128,77,238,0.08)] backdrop-blur-sm dark:bg-bgSecondaryDark/35"
        style={{ "--service-delay": `${index * 0.7}s` }}
      >
